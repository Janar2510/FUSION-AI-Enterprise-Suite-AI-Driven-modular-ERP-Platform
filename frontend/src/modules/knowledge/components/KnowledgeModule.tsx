...
export const KnowledgeModule: React.FC = () => {
    ...
    const handleGenerateAI = async () => {
        ...
        setTimeout(() => {
            const aiContent = `# ${formData.title}\n\n## Overview\nThis documentation was automatically generated by FusionAI Resource Intelligence.\n\n### Key Purpose\nTo provide high-level context for ${formData.title} within the enterprise ecosystem.\n\n### Implementation Details\n- Automated sync with Odoo 19.0 schema\n- Skill-based validation enabled\n- Real-time conflict detection active`;
            setFormData(prev => ({ ...prev, body: aiContent }));
