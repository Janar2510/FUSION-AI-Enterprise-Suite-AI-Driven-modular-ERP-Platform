...
import { useExpensesStore, HrExpense } from '../stores/expensesStore';
import { useHRStore } from '@/modules/hr/stores/hrStore';
import { Receipt, CheckCircle, XCircle, DollarSign } from 'lucide-react';
...
export const ExpensesModule: React.FC = () => {
    const { expenses, fetchExpenses, createExpense, updateExpense, deleteExpense, approveExpense, refuseExpense } = useExpensesStore();
