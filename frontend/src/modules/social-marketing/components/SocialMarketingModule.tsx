            ...
            statusRibbon={
                <div className="flex items-center justify-between w-full">
                    <div className="flex gap-2">
                        {formData.state === 'draft' && <button onClick={() => handleAction('scheduled')} className="bg-primary-500 hover:bg-primary-500/80 text-white px-4 py-1.5 rounded text-sm transition-colors shadow-[0_0_15px_rgba(147,51,234,0.3)] shadow-primary-500/20">Schedule Options</button>}
            ...
            leftPanels={
                <div className="space-y-6">
                    <div className="border border-white/10 rounded-xl overflow-hidden bg-white/5 p-6">
                        ...
                        <textarea
                            className="w-full h-48 bg-black/20 border border-white/10 rounded-md px-4 py-3 text-white text-base outline-none focus:border-primary-500 transition-all resize-none"
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" className="accent-primary-500 w-4 h-4" checked={formData.postFacebook} onChange={(e) => setFormData({ ...formData, postFacebook: e.target.checked })} disabled={formData.state !== 'draft'} />
                            ...
                            <label className="flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" className="accent-primary-500 w-4 h-4" checked={formData.postTwitter} onChange={(e) => setFormData({ ...formData, postTwitter: e.target.checked })} disabled={formData.state !== 'draft'} />
                            ...
                            <label className="flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" className="accent-primary-500 w-4 h-4" checked={formData.postLinkedin} onChange={(e) => setFormData({ ...formData, postLinkedin: e.target.checked })} disabled={formData.state !== 'draft'} />
